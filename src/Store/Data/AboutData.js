...
export const featureListData = [
  ...
  },
  {
    ...
    subTitle:
      "ShoesFit is designed to help detect issues early, enabling timely intervention and preventive care, particularly for heart-related and neurological conditions.",
...
export const teamData = [
  {
    imgUrl: "images/about/omneya.jpg",
    name: "Prof. Omneya Attallah",
    designation: "Professor of Biomedical Engineering",
    description:
      "Professor with the department of electronics and communications engineering, arab academy for science, technology, and maritime transport.",
    social: [
      {
  ...
  {
    imgUrl: "images/about/samer.jpg",
    name: "Eng. Ahmed Samer",
    designation: "EC Engineer",
    description:
